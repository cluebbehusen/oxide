...
use oxide_bot::{Observation, PublicMapBriefing, SeatBot as Brain};
...
fn accepted_extractor_defense_intercepts_a_lone_raider() {
    use oxide_bot::executive::{ArmyMission, ArmyPurpose, ArmyState};
    use oxide_bot::{Executive, Intent};
...
fn two_live_fronts_get_exact_disjoint_responses_without_emptying_home() {
    use oxide_bot::executive::{ArmyPurpose, MissionDisposition};
