...
impl RepairWork {
    ...
    fn value(self, ticks: Tick) -> u64 {
        ...
        restored.saturating_sub((restored * oxide_sim::stats::REPAIR_COST_PERMILLE).div_ceil(1000))
    }
}
...
pub(crate) fn remaining_work(
    ...
    for (anchor, built) in bays {
        ...
        let capacity = HORIZON.saturating_sub(delay) / oxide_sim::stats::REPAIR_BAY_PERIOD
