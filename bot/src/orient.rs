...
mod tests {
    use super::*;
    use crate::executive::{Army, ArmyId, ArmyState};
    use crate::observation::{BuildingObs, OBSERVATION_VERSION, UnitObs};
    ...
    fn observation() -> Observation {
        ...
        Observation::from_data(ObservationData {
            ...
            my_repair_targets: vec![(UnitId(1), oxide_sim::ids::Target::Building(BuildingId(2)))],
    ...
    fn mission_objective_uses_footprint_orientation_without_changing_its_deadline() {
        use crate::executive::{ArmyMission, ArmyObjective, ArmyPurpose};
        let obs = Observation::from_data(ObservationData {
            map_width: 40,
            map_height: 32,
            ..crate::test_support::observation_data()
