...
use crate::resources::{ResourceSnapshot, SiteFootprint};
use chassis::Tick;
...
pub(crate) enum DefenseConstruction {
    Turret,
    Bastion,
    FlakTurret,
    ScuttleCharge,
...
pub(crate) struct FreshDefenseProposal {
...
impl FreshDefenseProposal {
    ...
    pub(crate) const fn site(&self) -> SiteFootprint {
        self.site
    }
    ...
    #[cfg(test)]
    pub(crate) fn with_ready_at(mut self, tick: Tick) -> Self {
        self.ready_at = tick;
        self
    }
...
impl UtilityPolicy {
    ...
    pub(crate) fn fresh_defense_proposals(
        &self,
    ...
    pub(crate) fn commit_adjudicated_defense(
        &mut self,
...
fn confirmed_air_threat(
    ...
    let threatening_airframe = |kind: oxide_sim::stats::UnitKind| {
...
mod tests {
    ...
    fn building(kind: BuildingKind, built: bool) -> BuildingObs {
        BuildingObs {
            built,
            ..crate::test_support::building(1, PlayerId(0), kind, TilePos::new(2, 2))
        }
    }
    ...
    fn admission_reserve_skips_unfundable_geometry_without_becoming_a_claim() {
        let (mut obs, briefing) = opportunity_fixture();
        let profile = low_fortification_profile();
        let reserve = crate::allocation::voluntary_construction_admission_reserve(90, 0);
    ...
    fn defense_quote(
        ...
        StrategicDefenseQuote {
            placement: crate::utility::defense::DefensePlacement {
                anchor,
                builder: UnitId(1),
            },
    ...
    fn reinforcement_already_at_the_site_needs_one_cost_query_and_no_paths() {
        ...
        let (arrival, work) = crate::navigation::work::measure(|| {
