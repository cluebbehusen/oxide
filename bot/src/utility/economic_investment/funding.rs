...
pub(in crate::utility) struct FundingCalendar<'a> {
...
impl<'a> FundingCalendar<'a> {
    pub(in crate::utility) fn new(context: &EconomicInvestmentContext<'a>) -> Self {
    ...
    pub(in crate::utility) fn delay(&self, cost: u32, deadline: u64) -> u64 {
