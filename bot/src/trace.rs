...
pub const DECISION_TRACE_VERSION: u32 = 13;

const RESOURCE_FORECAST_TICKS: Tick = oxide_sim::TICKS_PER_SECOND as Tick * 60;
...
pub struct RepairProgramTrace {
    ...
    pub worker: UnitId,
    /// Exact own patient.
    pub patient: oxide_sim::ids::Target,
...
pub struct DeploymentReleaseTrace {
    ...
    pub asset: oxide_sim::ids::Target,
...
impl From<crate::utility::ReconConsumer> for ReconConsumerTrace {
    fn from(value: crate::utility::ReconConsumer) -> Self {
        use crate::utility::ReconConsumer;
        match value {
...
pub enum ProposalKeyTrace {
    ...
    SupportConstruction {
        ...
        action: crate::utility::EconomicInvestmentKey,
    },
...
impl From<crate::allocation::PaidQueueClaim> for PaidQueueClaimTrace {
    fn from(claim: crate::allocation::PaidQueueClaim) -> Self {
        Self {
...
mod tests {
    ...
    fn bounded_allocation_trace_always_retains_the_accepted_defense() {
        ...
        let proposals = (0..=ALLOCATION_TRACE_ENTRY_LIMIT)
            .map(|index| {
                let proposal = crate::utility::FreshDefenseProposal::fixture(
                    crate::utility::DefenseConstruction::Turret,
    ...
    fn serialized_trace_has_a_fixed_schema() {
        assert_eq!(DECISION_TRACE_VERSION, 13);
