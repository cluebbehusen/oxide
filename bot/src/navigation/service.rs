...
use crate::{Orientation, PublicMapBriefing, observation::Observation};
...
impl<'a> ServiceRoutes<'a> {
    ...
    pub(crate) fn producer_component(
        &mut self,
        producer: BuildingId,
        kind: UnitKind,
    ) -> Option<usize> {
    ...
    pub(crate) fn components_for_targets(
        &mut self,
        domain: Domain,
        targets: &[ServiceTarget],
    ) -> Vec<usize> {
    ...
    pub(crate) fn components_for_target(
        &mut self,
        domain: Domain,
    ...
    pub(crate) fn origin_components(&mut self, domain: Domain, origin: TilePos) -> Vec<usize> {
