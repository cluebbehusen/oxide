...
impl Search {
    ...
    pub(crate) fn last_search_exhausted(&self) -> bool {
        self.scratch.last_search_exhausted()
    }
    pub(crate) fn last_search_reached(&self, tile: TilePos) -> bool {
    ...
    pub(super) fn path_with_distances(
        ...
        crate::query_work::record(
            query_purpose,
            crate::query_work::QueryOperation::PathSearch,
...
pub(crate) fn reachable(
    ...
    if cells > oxide_sim::stats::PATH_EXPANSION_CAP as usize {
