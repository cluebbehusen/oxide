...
use crate::query_work::{QueryOperation, QueryPurpose};
use chassis::grid::TilePos;
use oxide_sim::{map::Terrain, stats::Domain};
...
impl NavigationInputs {
    pub fn surface(
        ...
        let build = || {
            crate::query_work::record(purpose, QueryOperation::PrepareSurface, ordinary.open.len());
