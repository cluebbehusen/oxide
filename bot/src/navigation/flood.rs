...
pub(crate) fn area(width: i32, height: i32) -> usize {
...
pub(crate) fn tile_index(width: i32, height: i32, tile: TilePos) -> Option<usize> {
...
pub(crate) fn labels(query_purpose: QueryPurpose, open: &[bool], map_size: (i32, i32)) -> Vec<u32> {
    crate::query_work::record(
        query_purpose,
        crate::query_work::QueryOperation::Components,
        open.len(),
    );
