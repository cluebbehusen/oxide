...
fn row_index(e: &StateIntegrityError) -> usize {
    ...
    match e {
        ...
        E::BuildingHpOutOfRange(_) => 24,
        E::BuildingProgressOutOfRange(_) => 25,
        E::BuildingCooldownOutOfRange(_) => 26,
        E::UnmintedBuildingFocus(_) => 27,
        E::InvalidBuildingFocus(_) => 28,
        E::OverlongBuildingQueue(_) => 29,
        E::UnproducibleQueueEntry(_) => 30,
        E::BuildingOutsideEnvelope(_) => 31,
        E::IncoherentSalvageLedger(_) => 32,
        E::LiveBuildingMarkedSalvaged(_) => 33,
        E::ForeignShellOwner(_) => 34,
        E::ShellOutsideEnvelope(_) => 35,
        E::UnmintedShellShooter(_) => 36,
        E::ForeignGhostOwner(_) => 37,
        E::FriendlyGhost(_) => 38,
        E::GhostOutsideEnvelope(_) => 39,
        E::UnsortedGhosts(_) => 40,
        E::ContactOutsideEnvelope(_) => 41,
        E::UnsortedContacts(_) => 42,
        E::OverlongSalvageIncidentMemory(_) => 43,
        E::SalvageIncidentOutsideEnvelope(_) => 44,
        E::ExpiredSalvageIncident(_) => 45,
        E::SalvageIncidentExpiryBeyondHorizon(_) => 46,
        E::UnsortedSalvageIncidents(_) => 47,
    }
}
