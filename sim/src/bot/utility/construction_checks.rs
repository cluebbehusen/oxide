...
use super::*;
use crate::bot::navigation::paths::{PathQueries, path_cost};
...
pub(super) struct GroundKnowledge<'a> {
    ...
    pub(super) planning: Option<&'a crate::bot::planning::PlanningWork>,
    pub(super) local_planning: crate::bot::planning::PlanningWork,
...
impl<'a> GroundKnowledge<'a> {
    ...
    pub(super) fn planning(&self) -> &crate::bot::planning::PlanningWork {
