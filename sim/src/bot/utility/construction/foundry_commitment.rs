...
pub(in crate::bot::utility) struct FoundrySavingCommitment {
    pub(in crate::bot::utility) plan: FoundryExpansionPlan,
    pub(in crate::bot::utility) accepted_at: Tick,
    pub(in crate::bot::utility) required_scrap: u32,
    forecast_basis: FoundryForecastBasis,
    pub(in crate::bot::utility) blocked_since: Option<u64>,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::bot::utility) struct FoundryForecastBasis {
    pub(in crate::bot::utility) planning_scrap: u32,
    pub(in crate::bot::utility) protected_reserve: u32,
    pub(in crate::bot::utility) deadline: Tick,
    pub(in crate::bot::utility) decision_cadence: Tick,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::bot::utility) struct FoundryFundingRevalidation {
    pub(in crate::bot::utility) planning_scrap: u32,
    pub(in crate::bot::utility) current_construction_capital: u32,
    pub(in crate::bot::utility) forecast_construction_capital: u32,
    pub(in crate::bot::utility) protected_reserve: u32,
    pub(in crate::bot::utility) deadline: Tick,
    pub(in crate::bot::utility) viable: bool,
}

/// How long a temporarily unexecutable frozen plan keeps its fund before the
/// policy releases it for deterministic replanning.
pub(in crate::bot::utility) const FOUNDRY_RECOVERY_TICKS: u64 = 600;
...
impl UtilityPolicy {
    ...
    pub(in crate::bot::utility) fn foundry_funding_revalidation(
        resources: &ResourceSnapshot,
    ...
    pub(in crate::bot::utility) fn finish_foundry_safety(
        &mut self,
        dials: &Dials,
        obs: &Observation,
    ...
    pub(in crate::bot) fn record_dispatched_foundry_build(
        &mut self,
        builders: &[UnitId],
        kind: BuildingKind,
        anchor: TilePos,
