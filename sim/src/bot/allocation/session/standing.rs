...
pub(super) struct StandingForceInputs<'a> {
    pub(super) observer: Option<&'a dyn crate::bot::observer::PhaseObserver>,
...
pub(super) struct StandingForceWork {
    pub(super) repair_work: Vec<crate::bot::standing_force::RepairWork>,
    pub(super) protection_work: Vec<crate::bot::utility::ProtectionRequest>,
    pub(super) raid: Option<crate::bot::raid::RaidProcurementRequest>,
}
...
mod tests {
    use super::*;
    use crate::{ids::BuildingId, stats::UnitKind};
    #[test]
