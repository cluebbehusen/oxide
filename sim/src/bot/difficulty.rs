//! Fair cognitive and execution limits for player-facing bot difficulties.
//!
...
//! strength judgment, and tactical coordination.
...
impl DifficultyTuning {
    /// Derives fair cognitive limits. Prime is the reference behavior; lower
    /// rungs lose promptness and precision, never legal actions or game rules.
